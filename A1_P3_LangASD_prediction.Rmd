...
```{r Load Data}
setwd("~/R/R - Datascripts/Assignment 1/Ihavenoideawhatimdoing-master")
...
#Merge two extracted MLU means into Bernie_data dataframe
Bernie_data1 <- merge(TD_Mean_MLU, Bernie_data1)  
Bernie_data1 <- merge(Bernie_Mean_MLU, Bernie_data1)
#Look tw Means for his MLU compared to other TD kids over visits.
#We see that he develops increasingly slower compared to the others. 
x <- Bernie_data1$Bernie_Mean_MLU - Bernie_data1$TD_Mean_MLU
#Find absolute difference between Bernie and the TD children
mad(x)
#0.2255055

predict(newlm3, Bernie_data)
